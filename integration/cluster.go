...
import (
	...
	"github.com/matheusd/etcd/etcdserver/api/v2http"
	"github.com/matheusd/etcd/etcdserver/api/v3client"
	"github.com/matheusd/etcd/etcdserver/api/v3election"
	epb "github.com/matheusd/etcd/etcdserver/api/v3election/v3electionpb"
	"github.com/matheusd/etcd/etcdserver/api/v3lock"
	lockpb "github.com/matheusd/etcd/etcdserver/api/v3lock/v3lockpb"
